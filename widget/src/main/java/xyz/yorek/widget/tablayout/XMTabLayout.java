 ...
 *
 * 复制至https://github.com/material-components/material-components-android/blob/1.4.0/lib/java/com/google/android/material/tabs/TabLayout.java
 * 仅修改了tabIndicatorInterpolator值，现在实现为XMFixedTabIndicatorInterpolator，实现自定义指示器
 * 其他特性在子类ImageTabLayout中通过公共接口实现，这样侵入性不大，可方便地同步最新上游代码
 */
@ViewPager.DecorView
public class XMTabLayout extends HorizontalScrollView {
  ...
  /**
   * Gravity used to fill the {@link XMTabLayout} as much as possible. This option only takes effect
  ...
  /**
   * Gravity used to lay out the tabs in the center of the {@link XMTabLayout}.
   *
   * @see #setTabGravity(int)
   * @see #getTabGravity()
   */
  ...
  /**
   * Gravity used to lay out the tabs aligned to the start of the {@link XMTabLayout}.
   *
   * @see #setTabGravity(int)
   * @see #getTabGravity()
   */
   ...
   * XMTabLayout}. This will only take effect if the indicator height is set via the custom indicator
   ...
   * width of the {@link XMTabLayout}. This will disregard {@code tabIndicatorHeight} and the
  ...
  private XMTabIndicatorInterpolator tabIndicatorInterpolator;
  ...
  public XMTabLayout(@NonNull Context context) {
    this(context, null);
  }

  public XMTabLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
    this(context, attrs, R.attr.tabStyle);
  }

  public XMTabLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    TypedArray a =
        XMThemeEnforcement.obtainStyledAttributes(
            context,
            attrs,
    ...
    setSelectedTabIndicator(
        XMMaterialResources.getDrawable(context, a, R.styleable.TabLayout_tabIndicator));
    ...
    try {
      ...
      tabTextColors =
          XMMaterialResources.getColorStateList(
              context,
              ta,
    ...
    if (a.hasValue(R.styleable.TabLayout_tabTextColor)) {
      ...
      tabTextColors =
              XMMaterialResources.getColorStateList(context, a, R.styleable.TabLayout_tabTextColor);
    }
    ...
    tabIconTint =
        XMMaterialResources.getColorStateList(context, a, R.styleable.TabLayout_tabIconTint);
    tabIconTintMode =
        XMViewUtils.parseTintMode(a.getInt(R.styleable.TabLayout_tabIconTintMode, -1), null);

    tabRippleColorStateList =
        XMMaterialResources.getColorStateList(context, a, R.styleable.TabLayout_tabRippleColor);
  ...
  /**
   * Returns the current mode used by this {@link XMTabLayout}.
   *
   * @see #setTabMode(int)
   */
  @Mode
  ...
  /**
   * Set the indicator gravity used to align the tab selection indicator in the {@link XMTabLayout}.
   ...
   * indicator height and stretch across the entire height and width of the {@link XMTabLayout}. This
  ...
  public void setTabIndicatorAnimationMode(
    ...
    switch (tabIndicatorAnimationMode) {
      case INDICATOR_ANIMATION_MODE_LINEAR:
        this.tabIndicatorInterpolator = new FixedTabIndicatorInterpolator();
        break;
      case INDICATOR_ANIMATION_MODE_ELASTIC:
        this.tabIndicatorInterpolator = new XMElasticTabIndicatorInterpolator();
        break;
      default:
  ...
  /**
   * Set whether this {@link XMTabLayout} will have an unbounded ripple effect or if ripple will be
  ...
  /**
   * Returns whether this {@link XMTabLayout} has an unbounded ripple effect, or if ripple is bound to
   * the tab item size.
   *
   ...
   *
   * <p>Setting the indicator drawable to null will cause {@link XMTabLayout} to use the default,
  ...
  /**
   * The one-stop shop for setting up this {@link XMTabLayout} with a {@link ViewPager}.
   *
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    // height
    final int idealHeight = Math.round(XMViewUtils.dpToPx(getContext(), getDefaultHeight()));
    ...
    if (MeasureSpec.getMode(widthMeasureSpec) != MeasureSpec.UNSPECIFIED) {
      ...
      tabMaxWidth =
          requestedTabMaxWidth > 0
              ? requestedTabMaxWidth
              : (int) (specWidth - XMViewUtils.dpToPx(getContext(), TAB_MIN_WIDTH_MARGIN));
    }
  ...
  public static class Tab {
    ...
    @Nullable public XMTabLayout parent;
    // TODO(b/76413401): make package private after the widget migration is finished
     ...
     *
     * <p>Do not rely on this if using {@link XMTabLayout#setupWithViewPager(ViewPager)}
     *
  ...
  /** A {@link LinearLayout} containing {@link Tab} instances for use with {@link XMTabLayout}. */
  public final class TabView extends LinearLayout {
    ...
    private void updateBackgroundDrawable(Context context) {
      ...
      if (tabRippleColorStateList != null) {
        ...
        ColorStateList rippleColor =
            XMRippleUtils.convertToRippleDrawableColor(tabRippleColorStateList);
    ...
    protected void drawableStateChanged() {
      ...
      if (changed) {
        invalidate();
        XMTabLayout.this.invalidate(); // Invalidate TabLayout, which draws mBaseBackgroundDrawable
      }
    }
    ...
    private void tryAttachBadgeToAnchor(@Nullable View anchorView) {
      ...
      if (anchorView != null) {
        clipViewToPaddingForBadge(false);
          XMBadgeUtils.attachBadgeDrawable(
    ...
    private void tryRemoveBadgeFromAnchor() {
      ...
      if (badgeAnchorView != null) {
        XMBadgeUtils.detachBadgeDrawable(badgeDrawable, badgeAnchorView);
    ...
    private void updateTextAndIcon(
      ...
      if (iconView != null) {
        ...
        if (hasText && iconView.getVisibility() == VISIBLE) {
          ...
          iconMargin = (int) XMViewUtils.dpToPx(getContext(), DEFAULT_GAP_TEXT_ICON);
        }
        if (inlineLabel) {
    ...
    private void tryUpdateBadgeDrawableBounds(@NonNull View anchor) {
      ...
      if (hasBadgeDrawable() && anchor == badgeAnchorView) {
        XMBadgeUtils.setBadgeDrawableBounds(badgeDrawable, anchor, getCustomParentForBadge(anchor));
      }
    }
  ...
  class SlidingTabIndicator extends LinearLayout {
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
      ...
      if ((tabGravity == GRAVITY_CENTER) || mode == MODE_AUTO) {
        ...
        final int gutter = (int) XMViewUtils.dpToPx(getContext(), FIXED_WRAP_GUTTER_MIN);
        boolean remeasure = false;
    ...
    private void jumpIndicatorToSelectedPosition() {
      ...
      tabIndicatorInterpolator.setIndicatorBoundsForTab(
          XMTabLayout.this, currentView, tabSelectedIndicator);
    }
    ...
    private void tweenIndicatorPosition(View startTitle, View endTitle, float fraction) {
      ...
      if (hasVisibleTitle) {
        tabIndicatorInterpolator.setIndicatorBoundsForOffset(
            XMTabLayout.this, startTitle, endTitle, fraction, tabSelectedIndicator);
      } else {
   ...
   * provided {@link XMTabLayout} so that the tab position is kept in sync.
   *
  ...
  public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
    @NonNull private final WeakReference<XMTabLayout> tabLayoutRef;
    private int previousScrollState;
    private int scrollState;

    public TabLayoutOnPageChangeListener(XMTabLayout tabLayout) {
    ...
    public void onPageScrolled(
      ...
      final XMTabLayout tabLayout = tabLayoutRef.get();
      if (tabLayout != null) {
  ...
  private class AdapterChangeListener implements ViewPager.OnAdapterChangeListener {
    ...
    public void onAdapterChanged(
      ...
      if (XMTabLayout.this.viewPager == viewPager) {
